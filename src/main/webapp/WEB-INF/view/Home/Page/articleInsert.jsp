...
<form class="layui-form" style="width: 100%" method="post" id="myForm" action="/insertArticleSubmit">
...
<div class="layui-form-item layui-form-text">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="radio" name="articleStatus" value="0" title="发布博客" checked>
    ...
    <blockquote class="layui-elem-quote layui-quote-nm">
        ...
        3、插入代码前，可以点击 <a href="http://tool.oschina.net/highlight" target="_blank">代码高亮</a>,将代码转成HTML格式
