...
<style type="text/css">
    body{
        background:url(https://images.unsplash.com/photo-1557174794-1b0fb7e03298?ixlib=rb-1.2.1&auto=format&fit=crop&w=650&q=80) no-repeat;
        width:100%;
        height:40%;
...
<rapid:override name="content">
    ...
    <br><br>
    <form class="layui-form" action="/fore/userEditSubmit" id="userForm"
          method="post" >
