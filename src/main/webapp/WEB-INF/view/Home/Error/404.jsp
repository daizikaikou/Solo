        ...
        <div class="error-page-main">
            ...
            <div class="error-page-actions">
                ...
                <div>
                    <h4>可以尝试：</h4>
                    <ol>
                        <li><a href="/article">返回首页</a></li>
                        <li><a href="/message">留言反馈</a></li>
                        <li>
                            <a target="_blank" rel="external nofollow" href="http://wpa.qq.com/msgrd?v=3&amp;uin=2649030395&amp;site=qq&amp;menu=yes"><i class="fa fa-qq"></i>联系站长</a>
                        </li>
                    </ol>
                </div>
            </div>
