...
<div id="login">
    ...
    <form name="loginForm" id="loginForm"  method="post">
        ...
        <p class="register" style="float:right;text-align:right;  "><a href="/register" style="color:#000;text-decoration: none;font-size: 12px;font-weight: bold"  class="pull-right" />免费注册</a> </p>
        </div>
        <div style="width:100%" >
            <br/>
            <br/>
            <br/>
        <p class="submit" >
            <input type="button" style="width: 100%" name="wp-submit" id="submit-btn" class="button button-primary button-large" value="登录" />
        </p>
        </div>
    </form>
    ...
    <p id="backtoblog"><a href="/article">&larr; 返回到Solo博客</a></p>
